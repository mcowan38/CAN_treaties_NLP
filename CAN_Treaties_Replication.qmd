...
# Load Data:
load("./00_scripts/01_CAN/CAN_KPC1.rdata")
load("./00_scripts/01_CAN/CAN_KPC2.rdata")
load("./00_scripts/01_CAN/CAN_KPC10.rdata")
```
...
universe <- read.csv("./00_documents/01_CAN_spreadsheets/CAN_universe_cases.csv")
universed <- gsub("\\/", "-", universe$Date)
universe$Date <-  as.Date(universed, format = "%Y-%m-%d")


# Pull in PC1 estimates
load(file = "./00_scripts/01_CAN/CAN_KPC1.rdata")
rot <- KPC1@rotated
...
# universe of cases (again, needs to match elements)
universe <-
  read.csv("./00_documents/01_CAN_spreadsheets/CAN_universe_cases.csv")
...
load(file = "./00_scripts/01_CAN/CAN_KPC2.rdata")
rot <- KPC2@rotated
