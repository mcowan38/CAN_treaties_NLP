...
```{r old_scree_plot, include = FALSE}
...
importance_df_pc1 <- read.csv("00_documents/visuals/term_importance_PC1_douglas.csv")
```
...
importance_df_1 <- read.csv(  "./00_documents/visuals/term_importance_xgboost_PC1_douglas.csv")
```
